                    ...
                    vacancy && (
                        <>
                            ...
                            <div style={{ marginTop: isMobile ? 20 : 80 }}>
                                {vacancy?.is_remote && (
                                    ...
                                    >
                                        ...
                                        />
                                        {
                                            dataTranslVacancySection.preTitle[
                                                locale
                                            ]
                                        }
                                    </div>
                            ...
                            >
                                <ButtonBack
                                    title={
                                        dataTranslVacancySection.btnOtherVac[
                                            locale
                                        ]
                                    }
                                ...
                                <ButtonBack
                                    title={
                                        dataTranslVacancySection.btnSendRes[
                                            locale
                                        ]
                                    }
                                    href={`/${slagLocale[locale]}/form?page=vacancies${encodeURIComponent("/")}${slug}&form=cv`}
                                    withArrow={false}
                                    isDark={true}
                                />
                            </div>
...
function SingleCard(props) {
    ...
    const { name, department, locale, is_active } = props
    console.log(is_active)

    return (
        <div
            style={
                isMobile ? { ...styles.wrap, flexFlow: "column" } : styles.wrap
            }
        >
            <div
                style={
                ...
                <div>
                    ...
                    {!is_active && (
                        <>
                            ...
                            >
                                Но если вы подходите на эту роль, оставьте свое
                                резюме и мы свяжемся с вами, когда у нас
                                появится подобная вакансия
                            </div>
                        </>
                    )}
                </div>
...
const styles = {
    ...
    imgWrap: { flex: 5, height: "100%", zIndex: 1 },
    img: {
        width: "100%",
        transform: "scale(1.3)",
        height: "100%",
